...
export default function Hero() {
  return (
    <div className="relative bg-[#F0F2F3] w-full h-auto lg:h-[850px] px-4 py-10 lg:py-0 rounded-lg">
      {/* Container */}
      <div className="max-w-[1321px] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-0">
        ...
        <div className="space-y-5 px-4 lg:px-10 mt-5">
          ...
          <div className="flex justify-start">
            <button className="bg-[#029FAE] text-white flex items-center justify-center px-6 py-3 rounded-lg text-[16px] leading-[17.6px] gap-2">
              Shop Now
